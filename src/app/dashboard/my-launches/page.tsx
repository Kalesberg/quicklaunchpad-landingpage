      ...
      <p className="text-lg font-bold mb-6">My Launches</p>
        ...
        <div className="mx-6 my-24 flex flex-col items-center justify-center">
          <Image
            ...
            height={128}
          />
          <p className="text-[#696C80] text-lg font-bold pt-10 pb-2">Looks Like You Haven't Joined A Launch Yet!</p>
          <p className="text-[#696C80] text-sm ">
            No problem, you can check our Live and Upcoming Launches for projects that might interest you. 
          </p>
          <Button
            variant="primary"
