...
const StepsToJoin: React.FC = () => {
  ...
  return (
    <section className="mb-12 py-[100px] px-[100px] rounded-lg shadow bg-gradient-to-b from-[#12131A] to-[#1a1825b0]">
      <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {steps.map((step, index) => (
          <div
            key={index}
            className="bg-[#1C1E29] p-6 rounded-2xl flex flex-col"
          >
            <div className="w-full flex justify-between gap-3 items-center mb-4">
              <div className="w-10 h-10 p-2 text-[#448AFF] bg-[#222735] rounded-lg">
                {step.icon}
              </div>
              ...
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                className="size-6 text-[#4d5d7994]"
              >
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
