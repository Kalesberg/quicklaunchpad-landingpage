...
const CTA: React.FC = () => {
  return (
    <section className="relative z-10 text-center mb-[88px] lg:mb-[120px] py-10 px-4 md:px-0 mx-3 lg:mx-0 rounded-2xl lg:rounded-3xl overflow-hidden">
      ...
      <div className="flex items-center justify-center gap-4 mt-4 lg:mt-[50px]">
        <Button
          variant="primary"
          size="medium"
